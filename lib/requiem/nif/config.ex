defmodule Requiem.NIF.Config do
  ...
  def enable_dgram(ptr, enabled, recv_queue_len, send_queue_len) do
    Bridge.config_enable_dgram(ptr, enabled, recv_queue_len, send_queue_len)
  end
end
